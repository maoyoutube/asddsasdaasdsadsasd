...
const app = express()
const TOKEN = "MTAwMTc1Nzc1MTQxODA0NDUwNg.GQZyqR.hDaBJaTUYGJF8BtFYw3GGYUQwrx0vbRicfVocw"; // 봇 토큰
const bottkn = new REST().setToken(TOKEN);
const staff = ["755056866148745346"] // 관리자 아이디
const embed_name = "Jero Bot" // 임베드 제목
const backup_log_channel = "1001791084290121850" // 백업 로그 채널 아이디
const license_log_channel = "1001759658907803708" // 라이센스 생성 로그 채널 아이디
const ba_log_channel = "1001759658907803708" // 등록 로그 채널 아이디
const bac_log_channel = "1001759658907803708" // 복구 로그 채널 아이디
